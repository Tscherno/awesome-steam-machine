...
An awesome list for Valve Steam Machine and SteamOS related resources.

## Contents

- [Official Valve Resources](#official-valve-resources)
- [Hardware](#hardware)
- [Operating Systems & Distros](#operating-systems--distros)
- [Game Launchers & Stores](#game-launchers--stores)
- [Compatibility & Proton](#compatibility--proton)
...
- [Steam Hardware](https://store.steampowered.com/hardware)

## Hardware

- [Steam Deck OLED](https://www.steamdeck.com/en/oled)
- [Framework Laptop 13 (SteamOS support)](https://frame.work/)
- [AYANEO](https://www.ayaneo.com/)
- [GPD Handheld PCs](https://www.gpd.hk/)
...
- [Steam Controller Configurator](https://store.steampowered.com/news/app/353370)
